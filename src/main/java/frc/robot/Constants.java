...
public final class Constants {
  ...
  public static class Wrist {
    ...
    public static final double k_wristHomeAngle = 144; //154;
    public static final double k_wristStartingAngle = k_wristHomeAngle / k_wristTicksToDegrees; // 124.48/k_wristTicksToDegrees;
  }
