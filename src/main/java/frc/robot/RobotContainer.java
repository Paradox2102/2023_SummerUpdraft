...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_driverController.button(3).whileTrue(new PositionReachCommand(m_reachSubsystem, 12));
      m_driverController.button(4).whileTrue(new IntakeCommand(m_intakeSubsystem, 0.3));
      m_driverController.button(5).whileTrue(new IntakeCommand(m_intakeSubsystem, -0.4));
  }
  /**
